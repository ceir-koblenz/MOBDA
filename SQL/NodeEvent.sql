SELECT EVENTS.ID AS id, EVENTS.EVENT_NAME AS title, EVENTS.event_ts AS created, USERS.UUID, EVENTS.SOURCE_ID, EVENTS.ITEM_UUID, REPLACE(EVENTS.ITEM_UUID, '-', '') AS match_item_uuid,
                  CASE
