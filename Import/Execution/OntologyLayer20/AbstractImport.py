...
#queryAbstractStructure muss zuerst ausgeführt werden
neodb.query(queryAbstractStructureA)
neodb.query(queryAbstractStructureB)
neodb.query(queryAbstractStructureC)
#alle anderen Queries können in beliebiger Reihenfolge ausgeführt werden
neodb.query(queryRelationAbstractAccountItemIntellectualEnity)
neodb.query(queryRelationAbstractAccountYellow)
neodb.query(queryRelationAbstractCollection)
neodb.query(queryRelationAbstractContainerSpace)
neodb.query(queryRelationAbstractIntellectualEntitySelf)
neodb.query(queryRelationAbstractIntellectualEntityComponent)
neodb.query(queryRelationAbstractIntellectualEntityContainerChilds)
neodb.query(queryRelationAbstractSimpleComponentIntellectualComponent)
neodb.query(queryRelationAbstractSocialDocumentContainer)
neodb.query(queryRelationAbstractSocialDocumentItem)
neodb.query(queryRelationAbstractSystemSpaceDigitalWorkspace)
neodb.query(queryRelationsAbstractIntellecutalComponentSelf)
